...
def negative_assert_symbol(first_name):
    ...
    # Проверяется, что в ответе есть поле message, и оно по шаблону
...
def test_create_user_1_letter_in_first_name_get_failure_response():
